    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('UsuarioID', models.AutoField(primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombreAnalisis', models.TextField(db_column='NombreAnalisis', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombreArea', models.CharField(db_column='NombreArea', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('SiguienteAtencion', models.DateTimeField(auto_now_add=True, db_column='SiguienteAtencion')),
                ('Observacion', models.TextField(db_column='Observacion')),
                ('AreatrabID', models.ForeignKey(db_column='AreaID', on_delete=django.db.models.deletion.CASCADE, to='gestion.areaserviciomodel')),
            ],
            options={
                'db_table': 'atencion',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Observacion', models.TextField(db_column='Observacion', null=True)),
                ('AnalisisID', models.ForeignKey(db_column='AnalisisID', on_delete=django.db.models.deletion.CASCADE, to='gestion.analisismodel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detalleDiagnostico', models.TextField(db_column='DetalleDiagnostico', max_length=50)),
                ('observacion', models.TextField(db_column='Observacion', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombreEspecie', models.CharField(db_column='NombreEspecie', max_length=50)),
                ('observacion', models.TextField(db_column='Observacion', null=True)),
            ],
            options={
                'db_table': 'especie',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('NombreDetalle', models.CharField(db_column='NombreDetalle', max_length=100)),
                ('observacion', models.TextField(db_column='Observacion', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombreDocumento', models.CharField(db_column='NombreDocumento', max_length=50)),
                ('observacion', models.TextField(db_column='Observacion', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombreTipoProducto', models.CharField(db_column='NombreTipoProducto', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombreTrabajo', models.CharField(db_column='NombreTrabajo', max_length=50)),
                ('observacion', models.TextField(db_column='Observacion', null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Usuario', models.ForeignKey(db_column='UsuarioID', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'Trabajador',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AtencionID', models.ForeignKey(db_column='AtencionID', on_delete=django.db.models.deletion.CASCADE, to='gestion.atencionmodel')),
                ('PacienteID', models.ForeignKey(db_column='PacienteID', on_delete=django.db.models.deletion.CASCADE, to='gestion.pacientemodel')),
                ('ServicioID', models.ForeignKey(db_column='ServicioID', on_delete=django.db.models.deletion.CASCADE, to='gestion.serviciomodel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('NombreRaza', models.CharField(db_column='NombreRaza', max_length=50)),
                ('Observacion', models.TextField(db_column='Observacion', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('NombreProducto', models.CharField(db_column='NombreProducto', max_length=250)),
                ('Descripcion', models.CharField(db_column='Descripcion', max_length=250, null=True)),
        ...
        migrations.AddField(
            ...
            name='Raza',
            field=models.ForeignKey(db_column='RazaID', on_delete=django.db.models.deletion.CASCADE, to='gestion.tipotrabajadormodel'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Descuento', models.FloatField(db_column='Descuento')),
                ('ProductoID', models.ForeignKey(db_column='ProductoID', on_delete=django.db.models.deletion.CASCADE, to='gestion.productomodel')),
                ('VentaID', models.ForeignKey(db_column='VentaID', on_delete=django.db.models.deletion.CASCADE, to='gestion.ventamodel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Observacion', models.TextField(db_column='Observacion', null=True)),
                ('AtencionID', models.ForeignKey(db_column='AtencionID', on_delete=django.db.models.deletion.CASCADE, to='gestion.atencionmodel')),
                ('TipoDetalleAtencionID', models.ForeignKey(db_column='TipodetalleAtencionID', on_delete=django.db.models.deletion.CASCADE, to='gestion.tipodetalleatencionmodel')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='clientemodel',
            name='Usuario',
            field=models.ForeignKey(db_column='UsuarioID', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='CitaModel',
            fields=[
                ...
                ('AreatrabID', models.ForeignKey(db_column='AreaID', on_delete=django.db.models.deletion.CASCADE, to='gestion.areaserviciomodel')),
                ('ClienteID', models.ForeignKey(db_column='ClienteID', on_delete=django.db.models.deletion.CASCADE, to='gestion.clientemodel')),
                ('PacienteID', models.ForeignKey(db_column='PacienteID', on_delete=django.db.models.deletion.CASCADE, to='gestion.pacientemodel')),
                ('ServicioID', models.ForeignKey(db_column='ServicioID', on_delete=django.db.models.deletion.CASCADE, to='gestion.serviciomodel')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='DiagnosticoID',
            field=models.ForeignKey(db_column='DiagnosticoID', on_delete=django.db.models.deletion.CASCADE, to='gestion.diagnosticomodel'),
        ),
        migrations.AddField(
            model_name='atencionmodel',
            name='HClinica',
        ...
        migrations.AddField(
            model_name='atencionmodel',
            name='ServicioID',
            field=models.ForeignKey(db_column='ServicioID', on_delete=django.db.models.deletion.CASCADE, to='gestion.serviciomodel'),
        ),
        migrations.AddField(
            model_name='atencionmodel',
            name='Trabajador',
            field=models.ForeignKey(db_column='TrabajadorID', on_delete=django.db.models.deletion.CASCADE, to='gestion.trabajadormodel'),
        ),
        migrations.AddField(
            model_name='areaserviciomodel',
            name='ServTrab',
            field=models.ForeignKey(db_column='ServTrabID', on_delete=django.db.models.deletion.CASCADE, to='gestion.serviciotrabajadormodel'),
        ),
        migrations.CreateModel(
            name='AlmacenModel',
            fields=[
